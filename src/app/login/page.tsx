    ...
    <div className="min-h-screen bg-rose-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Appuntamenti App</h1>
          <p className="text-gray-500 mt-1 text-sm">Gestione appuntamenti e promemoria</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-rose-100 p-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-gray-200 hover:bg-gray-50 disabled:opacity-50 text-gray-700 font-medium py-3 rounded-xl transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-rose-300 text-gray-800 placeholder-gray-400"
